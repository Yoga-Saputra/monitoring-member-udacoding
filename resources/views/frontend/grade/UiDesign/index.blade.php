        ...
        <div class="container">
            ...
            <div class="batch d-flex justify-content-end pb-2 pt-2">
                ...
                <select class="styp" type="text" name="angkatan"
                        onchange="document.location.href = 'leaderboard-UiDesign?angkatan=' + this.value+' ' ">
            ...
            <a href="{{ route('frontend.UiDesign.all') }}" class="d-flex justify-content-end" style="color: #48aa33"><b> All Leaderboard</b></a>
        </div>
    </section>
    <!-- ======= Portfolio Section ======= -->
