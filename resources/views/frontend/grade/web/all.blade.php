    ...
    <section id="leaderboard">
        <div class="container">
            <div class="section-header">
                <h2 class="text-center">Leaderboard Mentoring Program Web</h2>
            </div>
            <div class="batch d-flex justify-content-center pb-2 pt-2">
                <span>Batch : &nbsp;</span>
                <select class="styp" type="text" name="angkatan"
                        onchange="document.location.href = 'leaderboard-web-all?angkatan=' + this.value+' ' ">
            ...
            <a href="{{ route('frontend.web') }}" class="btn btn-success btn-sm" >Back</a>
        </div>
    </section>
</main><!-- End #main -->
@endsection
