        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 13px 8px;">{{ $totals->exam_4 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_10 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_11 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_12 }}</td>
                    ...
                    <td style="padding: 8px; vertical-align: middle;">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu animated-fast fadeIn">
                                <li>
                                    <a href="{{ route('week4.edit', $totals->id) }}" class="btn-edit"> <i
                                            class="fa fa-pencil"></i>Input Nilai </a>
                                </li>
                                {{--  <li>
                                    <form action="{{ route('week4.delete', $totals->id) }}" method="POST"
