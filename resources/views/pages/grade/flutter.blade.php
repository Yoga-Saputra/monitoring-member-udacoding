...
<select class="styp" type="text" name="angkatan"
        onchange="document.location.href = 'program-flutter?angkatan=' + this.value+' ' ">
...
<a href="{{ route('report.flutter') }}" class="btn btn-sm bg-green"><i class="fa fa-file-excel-o nav-icon"></i>&nbsp; Export</a>
