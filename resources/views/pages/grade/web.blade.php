...
<select class="styp" type="text" name="angkatan"
        onchange="document.location.href = 'program-web?angkatan=' + this.value+' ' ">
...
<a href="{{ route('report.web') }}" class="btn btn-sm bg-green"><i class="fa fa-file-excel-o nav-icon"></i>&nbsp; Export</a>
<button type="button" class="btn btn-sm bg-green" data-toggle="modal" data-target="#exam1Modal"> <i
        class="fa fa-plus nav-icon"></i>&nbsp;Add
</button>
@endsection
@section('content')
{{--
