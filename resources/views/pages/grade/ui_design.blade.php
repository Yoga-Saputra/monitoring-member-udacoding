...
<section class="content-header">
    <h1> Report Program UI Design </h1>
    <ol class="breadcrumb">
...
<select class="styp" type="text" name="angkatan"
        onchange="document.location.href = 'program-ui_design?angkatan=' + this.value+' ' ">
...
<a href="{{ route('report.uidesign') }}" class="btn btn-sm bg-green"><i class="fa fa-file-excel-o nav-icon"></i>&nbsp; Export</a>
