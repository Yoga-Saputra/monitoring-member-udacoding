...
<div class="box">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 13px 8px;">{{ $totals->exam_12 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_34 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_35 }}</td>
                    <td style="padding: 13px 8px;">{{ $totals->submission_36 }}</td>
                    ...
                    <td style="padding: 8px; vertical-align: middle;">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu animated-fast fadeIn">
                                <li>
                                    <a href="{{ route('week12.edit', $totals->id) }}" class="btn-edit"> <i
                                            class="fa fa-pencil"></i>Input Nilai </a>
                                </li>
                                {{--  <li>
                                    <form action="{{ route('week12.delete', $totals->id) }}" method="POST"
    ...
    {{--  <script type="text/javascript">
        function confirmdelete(id) {
            ...
            if (confirm(pesan)) {
                window.location = '{{ url("grade/week12/delete") }}/' + id;
            } else {
                return false;
            }
        }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h12 class="modal-title" id="exampleModalLabel">Masukan Data Dibawah Ini</h12>
                </div>
                <div class="modal-body">
                    <form action="{{ route('week12.tambah') }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <input name="exam12" type="number" value="{{ old('exam12') }}" class="form-control @error('exam12') is-invalid invalid @enderror" id="exam12" aria-describedby="exam12Help">
                            @error('exam12')
                        ...
                        <div class="form-group">
                            <label for="subexam34">Sub Exam 34</label>
                            <input name="subexam34" type="number" value="{{ old('subexam34') }}"
                                class="form-control @error('subexam34') is-invalid invalid @enderror" id="subexam34"
                                aria-describedby="subexam34Help">
                            @error('subexam34')
                            <span class="invalid"><i>{{$message}}</i></span>
                            @enderror
                        </div>
