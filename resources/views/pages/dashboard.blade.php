...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        <header class="main-header">
            <a href="index2.html" class="logo" style="background-color:#40962d !important;">
                ...
                <div class="container-fluid">
                    <div class="box">
                        <div class="box-body">
                                ...
                                <div class="col-xs-6">
                                    <div class="info-box bg-green">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">{{$peserta}}</span>
                                            <div class="progress">
                            ...
                            <h2 class="text-center">Selamat Datang <b>{{ Auth::user()->name }}</b></h2>
                            @endif
